...
<c:url value="/showAllExportNote" var="urlshowAllExportNote" />
<c:url value="/showAllImportNote" var="urlshowAllImportNote" />
<ul
	...
	<!-- Nav Item - Dashboard -->
	<li class="nav-item active"><a class="nav-link" href="${urlIndex}">
	...
	<sec:authorize access="hasRole('ADMIN')">
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			aria-expanded="true" aria-controls="collapseTwo"> <i
				class="fas fa-fw fa-user"></i> <span>User</span>
		</a>
			<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
				data-parent="#accordionSidebar">
				<div class="bg-white py-2 collapse-inner rounded">
					<!-- <h6 class="collapse-header">Custom Components:</h6> -->
					<a class="collapse-item" href="${urlShowUser}">All user</a> <a
	...
	<!-- Heading -->
	<div class="sidebar-heading">Stuff</div>
	...
	<li class="nav-item"><a class="nav-link collapsed" href="#"
		...
		<div id="collapsePages" class="collapse"
			...
			<div class="bg-white py-2 collapse-inner rounded">
				...
				<a class="collapse-item" href="${urlshowAllImportNote}">List Import</a>
				<a class="collapse-item" href="${urlAddExport}">Export</a>
				<a class="collapse-item" href="${urlshowAllExportNote}">List Export</a>
			</div>
		</div></li>
